# Botw.Formats.Byml.BModelList

Returns a Botw BModelList file. Write with <c>Botw.Formats.Writer.Byml.BModelList</c>
...
## BModelList(string ModelName

```
BModelList Model Name (SBFRES Name)
```

##  string UnitName

```
BModelList Unit Name (BFMODEL Model Name)
```
